...
var SequelizeErrors = require(path.join(__dirname, '../','Utilities/SequelizeErrors'));
...
module.exports = function(injector, options, logger) {
  ...
  var dbOptions = {
    ...
    typeValidation: (_.isBoolean(options.sql.typeValidation)) ? options.sql.typeValidation : false,
  }
  ...
  injector.merge('Errors', SequelizeErrors(Sequelize));
  ...
  var trySQLauth = function(){
    return sequelize.authenticate()
      .then(function(){
        ...
        return sequelize.sync({force: !dbOptions.persist})
          .then(function(){
